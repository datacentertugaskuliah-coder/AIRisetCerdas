"""
ALAS v8.7 — Asisten Riset Akademik
(c) 2024-2026 Alhumaira Store | obrolanpintar1987@gmail.com

Pembungkus Streamlit untuk dashboard ALAS v8.7 dengan gerbang login berbasis
...
st.set_page_config(
    page_title="ALAS v8.7 - Asisten Riset Akademik",
    page_icon="\U0001F4DA",
    layout="wide",
...
def _render_login() -> None:
    ...
    st.markdown(
        ...
        '<div class="alas-title">ALAS v8.7</div>'
