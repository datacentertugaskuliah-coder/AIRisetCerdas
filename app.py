...
Pembungkus Streamlit untuk dashboard ARAS v9.1 dengan gerbang login berbasis
...
st.set_page_config(
    page_title="ARAS v9.1 - Asisten Riset Akademik System",
    page_icon="\U0001F4DA",
    layout="wide",
...
def _render_login() -> None:
    ...
    st.markdown(
        ...
        '<div class="aras-title">ARAS v9.1</div>'
