...
Pembungkus Streamlit untuk dashboard ALAS v8.6 dengan gerbang login berbasis
...
st.set_page_config(
    page_title="ALAS v8.6 - Asisten Riset Akademik",
    page_icon="\U0001F4DA",
    layout="wide",
...
def _render_login() -> None:
    ...
    st.markdown(
        ...
        '<div class="alas-title">ALAS v8.6</div>'
